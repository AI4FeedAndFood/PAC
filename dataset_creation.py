...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_to_disk", action="store_true", default=True, help="Enregistrer le dataset sur le disque dur")
    parser.add_argument("--push_to_hub", action="store_true", default=False, help="Publier le dataset sur le hub")
